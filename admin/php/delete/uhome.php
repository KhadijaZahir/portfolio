...
if(isset($_POST['save'])){
      ...
      // "manual" escaping in mysqli ==
      //Escape special characters,to have a validate sql request
      ...
      $github=mysqli_real_escape_string($db,$_POST['github']); /*variables $_POST['github']*/
